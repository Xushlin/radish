...
namespace Radish.Adapters
{
    public class HttpListenerResponseAdapter : IHttpResponse
    {
        ...
        public long ContentLength64 { get { return _response.ContentLength64; } set { _response.ContentLength64 = value; } }
        public string ContentType { get { return _response.ContentType; } set { _response.ContentType = value; } }
        public CookieCollection Cookies { get { return _response.Cookies; } set { _response.Cookies = value; } }
        public WebHeaderCollection Headers { get { return _response.Headers; } set { _response.Headers = value; } }
        public bool KeepAlive { get { return _response.KeepAlive; } set { _response.KeepAlive = value; } }
        ...
        public string RedirectLocation { get { return _response.RedirectLocation; } set { _response.RedirectLocation = value; } }
        public bool SendChunked { get { return _response.SendChunked; } set { _response.SendChunked = value; } }
